...
def get_result(correct_chunks, true_chunks, pred_chunks,
    ...
    file_write.write(str(sum_true_counts) + "\t" + str(sum_true_chunks) + "\t" + str(sum_pred_chunks) + 
                     "\t" + str(sum_correct_chunks) + "\t" + str(100*nonO_correct_counts/nonO_true_counts) + 
                     "\t" + str(100*sum_correct_counts/sum_true_counts) + "\n")
    ...
    for t in chunk_types:
        ...
        file_write.write(t + "\t" + str(prec) + "\t" + str(rec) + "\t" + str(f1) + "\n")
    
    file_write.write(str(prec) + "\t" + str(rec) + "\t" + str(f1) + "\n")
    file_write.close()
